      ...
      <section className="bg-pink-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-red-900 sm:text-5xl md:text-6xl">Welcome to Our Store</h1>
            <p className="mt-6 max-w-2xl mx-auto text-xl text-sea bg-green-600-600">
              Discover amazing products at unbeatable prices. Your one-stop shop for everything you need.
            </p>
            <div className="mt-10">
              <button className="bg-black-600 text-green px-8 py-3 rounded-lg text-lg font-medium hover:bg-blue-700 transition-colors">
                Shop Now
              </button>
            </div>
          </div>
